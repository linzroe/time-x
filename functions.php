...
/**
 * 图像裁切
 timthumb(dmeng_get_the_thumbnail('post-thumbnail'), array('w' => '220', 'h' => '146'))
 */


function timthumb( $src){
    ...
    return get_stylesheet_directory_uri().'/timthumb.php?src='.$src.'&h=146&w=220&zc=1&a=c&q=100&s=1';
...
function dmeng_get_the_thumbnail($size = '300') {
	...
	if($image_url){
		$image_url =  get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url.'&h=146&w=220&zc=1&a=c&q=100&s=1';
